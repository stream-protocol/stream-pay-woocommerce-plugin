=== StreamPay™ Payment Gateway for WooCommerce ===

Contributors: Stream Protocol / StreamPay™
Tags: crypto, payment, payment gateway, streampay, bitcoin, solana, ripple, litecoin, etc..
...
StreamPay™ Payment Gateway is a service that allows users to with numerous supported cryptocurrencies
...
Stream Protocol / StreamPay™ has created a plugin for all major e-commerce including WooCommerce The plugin enables users to pay for items in your online store using any cryptocurrencies. Installing the plugin created a new payment method in your store. We provide a simple step-by-step guide on installing the plugin and setting up your Stream Payment Gateway to start accepting crypto payments. Don’t worry if you want to accept Bitcoin as payment, but your customer wants to use Ether: we will use the auto-conversion provided by StreamPay™ and everyone will use their favorite coin!
...
1. On the WooCommerce “Settings” page, go to the “Payment Gateways” tab, then click “StreamPay Payment Gateway”
...
== Screenshots ==
1. StreamPay Payment Gateway configuration
2. StreamPay Payment Gateway Order page
3. The Stream Pay Payment Gateway page
